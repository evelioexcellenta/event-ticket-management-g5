...
function Register(props) {
  ...
  return (
    <div style={{ marginTop: 100 }}>
      <Container
        boxShadow="dark-lg"
        bgGradient="linear(to-r, white.200, grey.500)"
        borderColor="black"
        borderWidth="2px"
        borderRadius="20px"
        w="100%"
      ...
      >
        <Stack spacing={3}>
          ...
          <Text as="b">Register now and start shopping</Text>
          ...
          <HStack spacing="300px">
              ...
              onClick={async () => {
                ...
                if (
                  ...
                  if (!emailRegex.test(state.email)) {
                    ...
                    const referralExists = await props.checkReferral(
                      state.referralCode
                    )
                    if (emailExists) {
                      ...
                      setAlert({
                        show: true,
                        message: "Your Referral Code does not exist",
                      })
                    } else {
            ...
            <Button>
              <Link href="/login" linkDecoration="none">
                Or login
              </Link>
            </Button>
          </HStack>
